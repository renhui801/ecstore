 ...
 * 维权信息查看
 */
class weixin_ctl_admin_shop_safeguard extends desktop_controller{
    ...
    public function _views(){
        ...
        foreach($sub_menu as $k=>$v){
            if($v['optional']==false){
                ...
                $show_menu[$k]['href'] = 'index.php?app=weixin&ctl=admin_shop_safeguard&act=index&view='.($k).(isset($_GET['optional_view'])?'&optional_view='.$_GET['optional_view'].'&view_from=dashboard':'');
